...
import (
	factory_authorization "rent_service/internal/factory/services/interfaces/authorization"
	...
	service_authorization "rent_service/internal/logic/services/interfaces/authorization"
...
type Factories struct {
	Authorization           factory_authorization.IFactory
...
type static struct {
	Authorization           service_authorization.IService
...
func New(factories Factories) DefaultContext {
...
func (self *DefaultContext) GetAuthorizationService() service_authorization.IService {
	if nil == self.services.Authorization {
		self.services.Authorization = self.factories.Authorization.CreateAuthorizationService()
	}

	return self.services.Authorization
}

func (self *DefaultContext) GetCategoryService() service_category.IService {
...
func (self *DefaultContext) GetDeliveryService() service_delivery.IService {
...
func (self *DefaultContext) GetDeliveryCompanyService() service_delivery.ICompanyService {
...
func (self *DefaultContext) GetInstanceService() service_instance.IService {
...
func (self *DefaultContext) GetInstancePayPlansService() service_instance.IPayPlansService {
...
func (self *DefaultContext) GetInstancePhotoService() service_instance.IPhotoService {
...
func (self *DefaultContext) GetInstanceReviewService() service_instance.IReviewService {
...
func (self *DefaultContext) GetLoginService() service_login.IService {
...
func (self *DefaultContext) GetPayMethodService() service_payment.IPayMethodService {
...
func (self *DefaultContext) GetUserPayMethodService() service_payment.IUserPayMethodService {
...
func (self *DefaultContext) GetRentPaymentService() service_payment.IRentPaymentService {
...
func (self *DefaultContext) GetPeriodService() service_period.IService {
...
func (self *DefaultContext) GetPhotoService() service_photo.IService {
...
func (self *DefaultContext) GetPickUpPointService() service_pickuppoint.IService {
...
func (self *DefaultContext) GetPickUpPointPhotoService() service_pickuppoint.IPhotoService {
...
func (self *DefaultContext) GetPickUpPointWorkingHoursService() service_pickuppoint.IWorkingHoursService {
...
func (self *DefaultContext) GetProductService() service_product.IService {
...
func (self *DefaultContext) GetProductCharacteristicsService() service_product.ICharacteristicsService {
...
func (self *DefaultContext) GetProductPhotoService() service_product.IPhotoService {
...
func (self *DefaultContext) GetProvisionService() service_provide.IService {
...
func (self *DefaultContext) GetProvisionRequestService() service_provide.IRequestService {
...
func (self *DefaultContext) GetProvisionRevokeService() service_provide.IRevokeService {
...
func (self *DefaultContext) GetRentService() service_rent.IService {
...
func (self *DefaultContext) GetRentRequestService() service_rent.IRequestService {
...
func (self *DefaultContext) GetRentReturnService() service_rent.IReturnService {
...
func (self *DefaultContext) GetStorageService() service_storage.IService {
...
func (self *DefaultContext) GetUserService() service_user.IService {
...
func (self *DefaultContext) GetUserProfileService() service_user.IProfileService {
...
func (self *DefaultContext) GetUserFavoriteService() service_user.IFavoriteService {
...
func (self *DefaultContext) GetRoleService() service_user.IRoleService {
